...
<table class="auto-style1">
    <tr>
        <td class="auto-style3" style="width: 30%">Employee_Id:</td>
        <td class="auto-style4" style="width: 40%">
            <asp:TextBox ID="TxbEmployeeId" runat="server" AutoPostBack="True" MaxLength="9"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="Indique número del Employee_Id" ForeColor="Red">*</asp:RequiredFieldValidator>
        </td>
        <td rowspan="2">
    ...
    <tr>
        ...
        <td class="auto-style4">
            <asp:TextBox ID="TxbEmployeeName" runat="server" MaxLength="50" Width="350px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2" ErrorMessage="Indique el nombre del Employee_Id." ForeColor="Red">*</asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
